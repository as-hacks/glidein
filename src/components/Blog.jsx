...
const Blog = () => {
  ...
  // Filter blogs: if activeTags is empty, show all. 
  // Otherwise, show blog if it has AT LEAST ONE of the active tags.
        ...
        {filteredBlogs.length === 0 ? (
          ...
          <div className="blog-grid">
            {filteredBlogs.map(blog => {
              ...
              return (
                <Link to={`/blog/${blog.id}`} key={blog.id} className="blog-card glass-panel" style={{ textDecoration: 'none' }}>
                  {blog.image_url && (
